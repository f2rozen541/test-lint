 ...
 */
public class IncrementLintGradleOperator {
    private final LintExecutionRequest descriptor;

    @Contract(pure = true)
    public IncrementLintGradleOperator(LintExecutionRequest descriptor) {
    ...
    private void abort(
            @Nullable IncrementLintClient client,
    ...
    private static void syncOptions(
            ...
            @NonNull IncrementLintClient client,
    ...
    public void lintAllVariants(@NonNull AndroidProject modelProject) throws IOException {
        ...
        List<Warning> mergedWarnings = IncrementLintClient.merge(warningMap, modelProject);
        ...
        if (!modelProject.getVariants().isEmpty()) {
            ...
            if (baselineFile != null && !baselineFile.exists()) {
                ...
                if (!ok) {
                    ...
                    if (IncrementLintClient.continueAfterBaseLineCreated()) {
                        return;
                    }
